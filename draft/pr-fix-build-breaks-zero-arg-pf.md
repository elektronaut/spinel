...
The `ArgumentError` for a class whose method needs arguments comes from #5024, already on master. This branch used to carry its own version of that dispatch change, and the rebase dropped it.
